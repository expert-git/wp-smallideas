...
function vantage_display_logo(){
	...
	if( empty($logo) ) {
		...
		//smallideas logo override
		$page_perma = get_permalink();
		$logoOverride = false;
		if((strpos(strtolower($page_perma),'sydney')!==false) || (strpos(strtolower($page_perma),'nsw/')!==false) || (strpos(strtolower($page_perma),'-nsw')!==false)){ //anything with sydney in the url				
			$logoOverride = 'sydney';
		} else if((strpos(strtolower($page_perma),'brisbane')!==false) || (strpos(strtolower($page_perma),'qld/')!==false)){ //anything with sydney in the url				
			$logoOverride = 'brisbane';
		} else if((strpos(strtolower($page_perma),'perth')!==false) || (strpos(strtolower($page_perma),'wa/')!==false)){ //anything with sydney in the url				
			$logoOverride = 'perth';
		} else if((strpos(strtolower($page_perma),'adelaide')!==false) || (strpos(strtolower($page_perma),'sa/')!==false)){ //anything with sydney in the url				
			$logoOverride = 'adelaide';
		} else if((strpos(strtolower($page_perma),'melbourne')!==false) || (strpos(strtolower($page_perma),'vic/')!==false)){ //anything with sydney in the url				
			$logoOverride = 'melbourne';
		} else if($page_perma=='https://smallideas.com.au/' || (strpos(strtolower($page_perma),'/directory/')!==false) || strpos(strtolower($page_perma),'/product-category/')!==false || strpos(strtolower($page_perma),'/buy/')!==false){
			$logoOverride = 'none';
		}
//		echo '[[]]'.$page_perma;
		...
		if( !empty( $logo_attributes ) ) {
			foreach($logo_attributes as $name => $val) {
				...
				//smallideas logo override
				if($logoOverride && $name=='src'){
					switch($logoOverride){
						case 'sydney':
							$logo_attributes_str[] = $name.'="/wp-content/uploads/2019/06/smallideas_sydney.png" ';
							break;
						case 'melbourne':
							$logo_attributes_str[] = $name.'="/wp-content/uploads/2019/03/Small_Ideas_Logo-copy-1.png" ';
							break;
						case 'brisbane':
							$logo_attributes_str[] = $name.'="/wp-content/uploads/2019/06/smallideas_brisbane.png" ';
							break;
						case 'perth':
							$logo_attributes_str[] = $name.'="/wp-content/uploads/2019/06/smallideas.png" ';
							break;
						case 'adelaide':
							$logo_attributes_str[] = $name.'="/wp-content/uploads/2019/06/smallideas_adelaide.png" ';
							break;
						case 'none':
							$logo_attributes_str[] = $name.'="/wp-content/uploads/2019/06/smallideas.png" ';
							break;
